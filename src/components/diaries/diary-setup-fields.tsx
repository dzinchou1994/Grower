...
const setupInputClass =
  "w-full rounded-lg border border-white/[0.08] bg-white/[0.04] px-3 py-2 text-sm text-white placeholder:text-slate-500 transition focus:border-lime-400/40 focus:outline-none focus:ring-2 focus:ring-lime-400/15";

const addButtonClass =
  "flex w-full items-center justify-center gap-2 rounded-lg border border-dashed border-white/[0.12] bg-white/[0.02] py-2.5 text-xs font-medium text-lime-300/95 transition hover:border-lime-400/30 hover:bg-lime-400/[0.06] hover:text-lime-200";
