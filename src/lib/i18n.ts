...
const translations = {
  ka: {
    ...
    home: {
      ...
      title: "ᲥᲐᲠᲗᲣᲚᲘ ᲙᲐᲜᲐᲑᲘᲡ ᲒᲐᲔᲠᲗᲘᲐᲜᲔᲑᲐ",
      ...
      topUsersXpSummary:
        "ᲐᲥᲢᲘᲣᲠᲝᲑᲘᲗ ᲐᲒᲠᲝᲕᲔᲑ ᲥᲣᲚᲔᲑᲡ, ᲔᲚᲝᲓᲔ ᲡᲘᲣᲠᲞᲠᲘᲖᲔᲑᲡ!",
      xpLabel: "XP",
      levelLabel: "დონე",
  ...
  en: {
    ...
    home: {
      ...
      topUsersXpHeading: "XP",
      topUsersXpSummary: "Earn points with activity - look out for surprises!",
      xpLabel: "XP",
      levelLabel: "Level",
  ...
  ru: {
    ...
    home: {
      ...
      topUsersXpHeading: "XP",
      topUsersXpSummary: "Копите очки за активность - сюрпризы впереди!",
      xpLabel: "XP",
      levelLabel: "Уровень",
